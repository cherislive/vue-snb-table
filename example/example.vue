...
<div id="demo" :class="{
  ...
  <div class="header">
    ...
    <div class="inner">
      <h1>Table 表格 <span>V2.6.X</span></h1>
...
&lt;script&gt;
  ...
  <div class="footer">
    ...
    <li>
      <iframe src="https://ghbtns.com/github-btn.html?user=cherislive&repo=vue-snb-table&type=star&count=false" frameborder="0" scrolling="0" width="50px" height="20px"></iframe>
    </li>
    <li>
      <iframe src="https://ghbtns.com/github-btn.html?user=cherislive&repo=vue-snb-table&type=fork&count=false" frameborder="0" scrolling="0" width="50px" height="20px"></iframe>
    </li>
  </ul>
  </div>
</div>
